...
Reviewfile_name =  "linkedin_reviews.csv"
cleanReviewfile_name = "linkedin_reviews_cols_clean.csv"

Tweetfile_name =  "linkedin_tweets.csv"
cleanTweetfile_name =  "linkedin_tweets_cols_clean.csv"
